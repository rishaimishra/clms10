...
<div class="card">
  ...
  <button class='btn btn-warning btn-sm pull-right' type='submit' name='submit' value='view'><h4>འཚོལ།</h4></button>
  </div>
  </form>
  </div>
</div>
...
<a href="{{ route('zheldrang_add_dzo') }}" title="View Details">
   <span class="btn btn-success btn-bg"><i class="fa fa-fw fa-hand-pointer"></i>&nbsp;&nbsp;&nbsp;<h3>ཞལ་གྲངས་བཙུགས་ནི་དོན་ལུ་ཨེབ་ནི།</h3></span></a>
...
<th><h3>ཆོས་ཆོགས།</h3></th>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td><h4><?php echo $dzo = App\tbl_designation::where('id', $dc->designation)->value('designation_dzo');?><h4></td>
                  <td>{{ $dc->religion }}</td>
...
<td>{{ $dc->tshetshok }}</td>
                 ...
                 <td>
                    <a href="{{ route('destroy_zheldrang_dzo', $dc->id) }}" onclick="return confirm('Are you sure, you want to Delete ?')">
                    <span class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i><h4>ཆ་མེད་གཏང་།</h4></span></a>
                  </td>           
              </tr> 
              @endforeach
