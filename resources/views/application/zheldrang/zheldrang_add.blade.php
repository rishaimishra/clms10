...
<br>
    ...
    <div class="container-fluid">
            <form action="{{ route('cid_search_zheldrang') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('zheldrang_store') }}">  
{{ csrf_field() }} 
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="cid">CID:</label>
 ...
 <script type="text/javascript">
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="designation">Occupation:</label>
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="religion">Religion:</label>
     <input type="text" class="form-control col-sm-6" name="religion" id="religion">
   </div> 

   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="religion">Subsidary/Branch/Chhoetshog:</label>
