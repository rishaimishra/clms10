...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('compliant_store_dzo') }}">  
...
{{ csrf_field() }} 
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="subject"><h3>དོན་ཚན།</h3></label>
     <input type="text" class="form-control col-sm-6" name="subject" id="subject">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="discription"><h3>ཉོག་བཤད་ ཁ་གསལ།</h3></label>
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="submitted_by"><h3>ཉོག་བཤད་བཀོད་མི།</h3></label>
     <input type="text" class="form-control col-sm-6" name="submitted_by" id="submitted_by">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label" for="phone"><h3>བརྒྱུད་འཕྲིན་ཨང་</h3></label>
     <input type="text"class="form-control col-sm-6" id="phone" name="phone" placeholder="Enter phone Number">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label" for="dzongkhag"><h3>གློག་འཕྲིན།<br> གློག་རིག་ཐོག་གི་ཡིག་འཕྲིན།</h3></label>
     <input type="email"class="form-control col-sm-6" id="email" name="email" placeholder="Email ID">
   </div>   
   <br>
   <div class="form-row">
     <label class="col-sm-4 col-form-label"  for="compliant_details"><h3>ཉོག་བཤད་ ཡིག་ཆ།</h3></label>
