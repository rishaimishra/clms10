...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">All Suggestions/Feedbacks Submissions</h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b>Suggestions/Feedbacks List</b>:</h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <thead>
              <tr style="text-align: left;">  
                  <th>No</th>
                  <th>Suggestions/Feedbacks Against</th>
                  <th>Subject</th>
                  <th>Submitted by</th>
                  <th>Submitted On</th>
                  <th>Action</th>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    <a href="{{ route('complaint_viewdetails', $dc->id) }}" title="View Details">
