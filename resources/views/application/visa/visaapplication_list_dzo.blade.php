...
<br>
    ...
    <div class="container-fluid">
      <h5 class="box-title"><b><h3>visa /སྐྱོད་ཐམ་ཞུ་ཚིག་ བཀང་ཤོག།</h3></b></h5>

      <p><b><h3>གཟིགས་སྐོར་འབད་ནི་ རྒྱུ་མཚན།:</h3></b>&nbsp;&nbsp;&nbsp;{{$purpose}}</p>
      <p><b><h3>འགྲུལ་ཡིག (ཟུར་དྲག):</h3></b>&nbsp;&nbsp;&nbsp;
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    @else<span class="btn btn-warning btn-sm"><h4>གནང་བ་འགྲོལ། </h4></span>@endif
                    @if($dc->resubmission == '1')<span class="btn btn-warning btn-sm"><h4>ལོག་ཕུལ་ནི།</h4></span>
                    @endif
                  </td>           
              </tr> 
              @endforeach
...
@if(Auth::user()->role_id == '3')
    <div class="form-row">
    <a href="{{ route('apply_visa_page_dzo',$dc->purposeid) }}" target="_blank" class="btn btn-warning btn-bg"><i class="fas fa-arrow-circle-right"></i>&nbsp;<h3>མགྱོནམོ་འཐེབ་ བཙུགས་ནི། </h3></a>
@endif
    </div>  
