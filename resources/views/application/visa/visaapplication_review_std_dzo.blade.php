...
<h3 style="color: orange;">ཞུ་ཡིག་ གྲུབ་འབྲས/གནས་སྟངས།</h3>
        <div class="form-row"> 
...
<input type="hidden" name="application_no" value="{{$do->application_no}}">
  {{ csrf_field() }} 
@endforeach
<h3 style="color: orange;">ཞུ་ཡིག་ བརྟག་ཞིབ།/ཐག་གཅད།</h3>
<div class="card">
  <div class="card-body">     
    ...
    <dd><input type="file" id="exampleInputFile8" class="form-control form-control-sm" name="student_visa_order[]" multiple=""></dd>
    <div class="form-row">
...
<div class="col-md-12">
  <div class="card"> 
      ...
      <iframe name='youriframe' style="width:800px; height:800px;" frameborder="0" border="0" cellspacing="0">སྔོན་ཞིབ།</iframe>
      </div>            
      </dl>
  </div>
</div>
