...
<div class="card"><br>
    <div class="btn-group w-100 mb-2">
       <a class="btn btn-warning active" data-filter="2"><h3>དྲུང་ཆེན་གྱི་ཁ་གསལ། </h3></a>
...
<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ route('new_secretary_details_store_dzo',$ro_id) }}">
      ...
      <div class="row">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="sname" id="sname" value="<?php echo $cDetail1[0]['firstDzoName'];?>" readonly required/>
            </div>
            <div class="form-group input-group-sm">
