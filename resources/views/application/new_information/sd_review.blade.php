...
<br>
    ...
    <div class="btn-group w-100 mb-2">
        <a class="btn btn-warning active" href="" data-filter="2">Secretary Details</a>
    </div>
    </div>
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;">New Secretary Details</h6>
      </div>
      @foreach($app as $doo)
      <div class="card-body">
...
<!--decision-->
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('approve_sd', $id) }}" onSubmit="return validateThisFrom (this);">
