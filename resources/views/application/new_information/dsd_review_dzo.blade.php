...
<br>
    ...
    <div class="btn-group w-100 mb-2">
        <a class="btn btn-warning active" href="" data-filter="2"><h3>དྲུང་ཆེན་འོགམ།</h3></a>
    </div>
    </div>
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;"><h3>དྲུང་ཆེན་འོགམ་གྱི་ཁ་གསལ་གསརཔ།</h3></h6>
      </div>
      @foreach($app as $d)
      <div class="card-body">
             <dt><h3>ངོ་མིང་།</h3></dt>
...
<!--decision-->
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('approve_dsd_dzo', $id) }}" onSubmit="return validateThisFrom (this);">
