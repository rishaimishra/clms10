...
<br>
    ...
    <div class="btn-group w-100 mb-2">
        <a class="btn btn-warning active" href="" data-filter="2"><h3>ཁྲི་འཛིན་འོག་མ་གྱི་ཁ་གསལ། </h3></a>
    </div>
    </div>
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;"><h3>ཁྲི་འཛིན་འོག་མ་གསརཔ། </h3></h6>
      </div>
      @foreach($app as $doo)
      <div class="card-body">
            <dt><h3>ངོ་མིང་།</h3></dt>
             ...
             <dd><?php echo $c = App\gewog_dzo::where('gewog_id', $doo->gewog)->value('gewog_name'); ?>
             </dd>
             <dt><h3>གཡུས།</h3></dt>
             <dd><?php echo $c = App\village_dzo::where('village_id', $doo->village)->value('village_name'); ?></dd>
             <dt><h3>གུང་ཨང་།</h3></dt>
             <dd>{{ $doo->houseno }}</dd>
             <dt><h3>ཁྲམ་ཨང་།</h3></dt>
             <dd>{{ $doo->thramno }}</dd>
...
<!--decision-->
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('approve_dcd_dzo', $id) }}" onSubmit="return validateThisFrom (this);">
