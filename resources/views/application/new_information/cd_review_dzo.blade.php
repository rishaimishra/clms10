...
<br>
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;"><h3>ཁྲི་འཛིན་གསརཔ།</h3></h6>
      </div>
      @foreach($app as $d)
      <div class="card-body">
             <dt><h3>ངོ་མིང་།</h3></dt>
...
<!--decision-->
<form role="form" method="POST" enctype="multipart/form-data" action="{{ route('approve_cd_dzo', $id) }}" onSubmit="return validateThisFrom (this);">
