  ...
  <div class="row">
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;"><h3>གནས་ཐོ་ཁ་གསལ།</h3></h6>
      </div>
      @foreach($siteview as $doo)
      <div class="card-body">
            <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>གནས་ཀྱི་མིང༌།</h3></dt>
             <dd class="col-form-label col-sm-6">{{ $doo->site_name }}</dd>
           </div>
           <div class="form-row"> 
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>གནས་ཀྱི་བཤད་པ།</h3></dt>
           ...
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>སབ་ཁྲ།</h3>Google Map URL</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->mapurl }}</dd>
           </div>
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>ལྷོ་བྱང་མཚམས་ཐིག </h3>Latitude:</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->latitude }}</dd>
           </div>
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>ཤར་ནུབ་མཚམས་ཐིག</h3>Longitude:</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->longitude }}</dd>
           </div>
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;"><h3>ས་གནས་ཀྱི་ བྱུང་རབས།</h3></dt>
