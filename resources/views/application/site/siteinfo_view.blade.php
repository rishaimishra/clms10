...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">All Religious Site Information</h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b>Religious Site List</b>:</h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td><?php echo $ge = App\gewog::where('gewog_id', $dc->gewog)->value('gewog_name');?></td>
                  <td>
                    <a href="{{ route('siteinfo_viewdetails', $dc->id) }}" title="View Details">
...
<div class="card">
  <div class="card-body">
  <form action="{{route('ro_site_searching')}}" method='post' id='view'>
  {{csrf_field()}} 
  <div class="form-row">
  <div class='col-md-12'>
