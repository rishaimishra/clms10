...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Religious Site Information Submission</h5>
              <p>
              <?php
...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('siteinfo_store') }}">  
{{ csrf_field() }} 
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="site_name">Name of Site:</label>
     <input type="text" class="form-control col-sm-6" name="site_name" id="site_name">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="discription">Site Description:</label>
   ...
   <div class="form-row">
     ...
     <option>Select Gewog Frist</option>
     </select>
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="mapurl">Google Map URL:</label>
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="sitehistory">History of the Site:</label>
     <textarea class="form-control col-sm-6" name="sitehistory" id="sitehistory" rows="4"></textarea>
   </div>
   <br>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="event_details">Attach Document:</label>
