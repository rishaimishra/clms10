...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('siteinfo_store_dzo') }}">  
{{ csrf_field() }} 
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="site_name"><h3>གནས་ཀྱི་མིང༌།</h3></label>
     <input type="text" class="form-control col-sm-6" name="site_name" id="site_name">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="discription"><h3>གནས་ཀྱི་བཤད་པ།</h3></label>
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="mapurl"><h3>སབ་ཁྲ།</h3>Google Map URL:</label>
     <input type="text" class="form-control col-sm-6" name="mapurl" id="mapurl">
   </div>
   <br><p>Google Map Coordinates:</p>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="latitude"><h3>ལྷོ་བྱང་མཚམས་ཐིག </h3>Latitude:</label>
     <input type="text" class="form-control col-sm-6" name="latitude" id="latitude">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="longitude"><h3>ཤར་ནུབ་མཚམས་ཐིག</h3>Longitude:</label>
     <input type="text" class="form-control col-sm-6" name="longitude" id="longitude">
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="sitehistory"><h3>ས་གནས་ཀྱི་ བྱུང་རབས།</h3></label>
     <textarea class="form-control col-sm-6" name="sitehistory" id="sitehistory" rows="4"></textarea>
   </div>
   <br>
   <h4>ཟུར་དྲག</h4>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="event_details"><h3>ཡིག་ཆ།</h3></label>
     <input type="file" id="exampleInputFile1"  class="form-control col-sm-6" name="site_details[]" multiple="">
   </div>
