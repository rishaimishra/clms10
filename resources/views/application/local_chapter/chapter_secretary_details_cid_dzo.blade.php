        ...
        <a class="btn btn-info" href="" data-filter="6"><h3>རྩིས་འཛིན་གྱི་ཁ་གསལ།</h3></a>
            ...
            <div class="row">
                ...
                <div class="card-body">
                   ...
                   <form action="{{ route('chapter_secretary_details_cid_dzo',$dets) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
...
<?php error_reporting(E_ALL & ~E_NOTICE);?>
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('chapter_secretary_details_store_dzo') }}">
...
<div class="form-group input-group-sm">
<label for="chairman"><h3>དྲུང་ཆེན་གྱི་ཡིག་ཆ།<font color="red">*</font></h3></label>
