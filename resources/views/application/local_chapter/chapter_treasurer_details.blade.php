...
<br>
    ...
    <div class="container-fluid">
      ...
      <div class="btn-group w-100 mb-2">
        ...
        <a class="btn btn-info active" href="" data-filter="6">Treasurer Details</a>
      </div>
      </div>
          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('chapter_treasurer_details_cid',$dets) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
  ...
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('chapter_treasurer_details_store') }}">
...
<div class="form-group input-group-sm">
<label for="chairman">Upload Treasurer Document:</label><font color="red">*</font>
