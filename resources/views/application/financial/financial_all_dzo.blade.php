...
@if(Auth::user()->role_id == '2')
    ...
    <div class="btn-group w-100 mb-2">
        <a class="btn btn-warning active" href="{{route('financial_all_dzo')}}" data-filter="2"><h3>ལོ་བསྟར་དངུལ་གྱི་སྙན་ཞུ་ཚུ་གི་ཞུ་བ།</h3></a>
        <a class="btn btn-warning" href="" data-filter="3"><h3>གནང་བ་འགྲོལ་ཚར་མི།</h3></a>
    </div>
    </div>
  <section class="content">
  <div class="container-fluid">
      <div class="box-header">
      <h5 class="box-title"><b><h3>ལོ་བསྟར་དངུལ་གྱི་སྙན་ཞུ།</h3></b></h5>
      </div>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    @endif
                    @if($dc->resubmission == '1')<span class="btn btn-warning btn-sm"><h4>ལོག་སྟེ་ཕུལ།</h4></span>
                    @endif

                  </td>
                  <td>
                    <a href="{{ route('financial_review_dzo',$dc->id) }}" title="View Details">
                    <span class="btn btn-success btn-sm"><i class="fa fa-fw fa-paste"></i><h4>བསྐྱར་ཞིབ་འབད།</h4></span></a>
                  </td>           
              </tr> 
              @endforeach
            </tbody>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    @elseif($dc->approve == '1')<span class="btn btn-warning btn-sm"><h4>གནང་བ་འགྲོལ།</h4></span>
                    @elseif($dc->approve == '2')<span class="btn btn-danger btn-sm"><h4>ཕྱིར་བཏོན།</h4></span>
                    <a href="{{ route('financial_resubmit_dzo',$dc->id) }}" title="View Details">
                    <span class="btn btn-success btn-sm"><h4>ལོག་སྟེ་ཕུལ།</h4></span></a>
                    @endif
                  </td>
                  <td>
                    <a href="{{ route('financial_review_dzo',$dc->id) }}" title="View Details">
