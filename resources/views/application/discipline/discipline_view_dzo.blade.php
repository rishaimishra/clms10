...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3>ཉེས་ཁྲིམས་བཀལ་མི་ཚུ་གི་ཐོ། </h3></h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b><h3>ཉེས་ཁྲིམས་བཀལ་མི་ ཚུ་གི་ཐོ། </h3></b></h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <tbody>
              <?php $id = 1;?>
              @foreach($discipline as $dc)
              <tr>
                  <td>{{$id++}}</td>
                  <td>{{ $dc->action_against }}</td>
                  <td><?php echo $dzo = App\tbl_agency::where('id', $dc->ro_name)->value('agency');?></td>
                  <td>{{ $dc->created_at }}</td>
                  <td>
                    <a href="{{ route('discipline_viewdetails_dzo', $dc->id) }}" title="View Details">
