...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">All Disciplinary Actions Taken By Chogdey Lhentsho.</h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b>List of Disciplinary Actions Taken</b>:</h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $dc->created_at }}</td>
                  <td>
                    <a href="{{ route('discipline_viewdetails', $dc->id) }}" title="View Details">
