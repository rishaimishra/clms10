...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3> ཐོ་བཀོད་ལས་ཕྱིར་འཐོན་འབད་ནིའི་ གསོལ་འདེབས་ཕུལ།</h3></h5>
              <p>
              <?php
...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('deregister_store_dzo') }}">  
{{ csrf_field() }} 
   <div class="form-row">
     <label class="col-sm-5 col-form-label"  for="deregister_date"><h3>འཐོན་འགྱོ་ནི་ སྤྱི་ཚེས།</h3></label>
     <input type="date" class="form-control col-sm-6" name="deregister_date" id="deregister_date">
   </div>
   <div class="form-row">
     <label class="col-sm-5 col-form-label"  for="reason"><h3>འཐོན་འགྱོ་དགོ་མི་ རྒྱུ་མཚན།</h3></label>
     <input type="text" class="form-control col-sm-6" name="reason" id="reason">
   </div>
   <div class="form-row">
     <label class="col-sm-5 col-form-label"  for="details"><h3>ཁ་གསལ།</h3></label>
   ...
   <div class="form-row">
     <label class="col-sm-5 col-form-label"  for="request_letter"><h3>ཞུ་བའི་ ཡི་གུ།</h3></label>
