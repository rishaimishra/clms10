...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Event Information Details</h5>
              <p>
              <?php
  ...
  <div class="row">
    ...
    <div class="card"> 
      ...
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;">Event Details</h6>
      </div>
      @foreach($eventview as $doo)
      <div class="card-body">
            <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;">Event Name:</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->event_name }}</dd>
           </div>
           <div class="form-row"> 
             <dt class="col-sm-5 col-form-label" style="text-align: right;">Event Description:</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->discription }}</dd> 
           </div>
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;">Event Venue:</dt>            
           ...
           <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;">Start Date:</dt>
             <dd class="col-form-label col-sm-6">{{ $doo->startdate }}</dd>
           </div>
            <div class="form-row">
             <dt class="col-sm-5 col-form-label" style="text-align: right;">End Date:</dt>
...
<div class="col-md-7">
  <div class="card"> 
      <dl class="dl-horizontal">
      <div class="card-header">
        <h6 class="card-title" style="color: orange;font-weight: bold;">Event Details Document</h6>
      </div>
      <div class="box-body">
        @foreach($docs as $d)
          &nbsp;&nbsp;&nbsp;{{ $d->filecat }}        
