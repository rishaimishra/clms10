...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3>མཛད་རིམ་ཐོ་བཀོད།</h3></h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b><h3>མཛད་རིམ་ཐོ་བཀོད།</h3></b></h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $dc->venue }}</td>
                  <td>
                    <a href="{{ route('eventinfo_viewdetails_dzo', $dc->id) }}" title="ཁ་གསལ">
...
<div class="card">
  <div class="card-body">
  <form action="{{route('ro_event_searching_dzo')}}" method='post' id='view'>
  {{csrf_field()}} 
  <div class="form-row">
  <div class='col-md-12'>
  ...
  <div class="container-fluid">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $dc->venue }}</td>
                  <td>
                    <a href="{{ route('eventinfo_viewdetails_dzo', $dc->id) }}" title="<h4>ཁ་གསལ།</h4>">
                    <span class="btn btn-success btn-sm"><i class="fa fa-fw fa-paste"></i><h4> ཁ་གསལ།</h4></span></a>
                  </td>            
              </tr> 
              @endforeach
