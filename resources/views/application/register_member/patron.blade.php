...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Add Patron Information</h5>
              <p>
              <?php
...
{{ csrf_field() }} 
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b>Patron Information</b>:</h5>
      </div>
        <a href="{{ route('register_patron') }}" title="View Details">
        <span class="btn btn-warning btn-bg"><i class="fa fa-fw fa-hand-pointer"></i>&nbsp;&nbsp;&nbsp;Click to add Patron</span></a>
  <div class="content-header">
  <div class="container-fluid">
            ...
            <thead>
              <tr style="text-align: left;">  
                  ...
                  <th style="width:6cm;">Photo</th>
                  <!--<th>Action</th>-->
              </tr>
            </thead>
            <tbody>
              <?php $id = 1;?>
              @foreach($patron as $dc)
              <tr>
                  <td>{{$id++}}</td>
                  <td>{{ $dc->name }}</td>
                  <td>{{ $dc->info }}</td>
                  ...
                  <!--<td>
                    <a href="{{ route('delete_patron', $dc->id) }}" onclick="return confirm('Are you sure, you want to Delete ?')">
