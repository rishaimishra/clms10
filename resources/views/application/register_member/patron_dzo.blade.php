...
{{ csrf_field() }} 
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b><h3>སྐྱབས་འཛིན་པའི་ཁ་གསལ།</h3></b></h5>
        ...
        <a href="{{ route('register_patron_dzo') }}" title="View Details">
        <span class="btn btn-warning btn-bg"><i class="fa fa-fw fa-hand-pointer"></i>&nbsp;&nbsp;&nbsp;<h3>བཙུགས་ནི་དོན་ལུ་ཨེབ།</h3></span></a>
  <div class="content-header">
  <div class="container-fluid">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <!--<td>
                    <a href="{{ route('delete_patron_dzo', $dc->id) }}" onclick="return confirm('Are you sure, you want to Delete ?')">
                    <span class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i><h4>བཏོན་གཏང་ནི།</h4></span></a>
                  </td> -->          
              </tr> 
              @endforeach
