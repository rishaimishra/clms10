...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3>སྐྱབས་འཛིན་པའི་ཁ་གསལ།།</h3></h5>
              <p>
              <?php
...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('patron_store_dzo') }}">  
{{ csrf_field() }} 
   <div class="form-row">
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="info"><h3>ཁ་གསལ། </h3></label>
     <textarea class="form-control col-sm-6" name="info" id="info" placeholder="Enter General Information" rows="4"></textarea>
   </div>
   <div class="form-row">
     <label class="col-sm-3 col-form-label" for="photo"><h3>ངོ་པར།</h3></label>
     <input type="file" name="photo" class="form-control col-sm-6" id='photo'>
   </div>
