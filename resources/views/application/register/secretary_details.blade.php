...
@if($token_no != '' && $sroid == '')
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info active" href="{{route('secretary_details',$ro_id)}}" data-filter="4">Secretary Details</a>
            ...
            <div class="row">
                <div class="col-md-4">
                <div class="card-body">
                  <form action="{{ route('cid_search_sdreg',$ro_id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
  ...
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('secretary_details_store') }}">
  ...
  {{ csrf_field() }}
                  ...
                  <div class="form-group input-group-sm">
                     ...
                     <option value="">Select Dzongkhag Frist</option>
                     </select>
                  </div> 
                  <div class="form-group input-group-sm">
                    <label for="village">Village:</label><font color="red">*</font>
                     <select name='village' id='village' class="form-control " required/>
                     <option value="">Select Gewog Frist</option>
                     </select>
                  </div>            
                </div>
...
@foreach($data as $app)
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('secretary_details_store_edit') }}">
  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
...
<div class="form-group input-group-sm">
<label for="chairman">Upload Secretary Details Document:</label>
<input type="file" id="exampleInputFile2"  class="form-control" name="sd[]" multiple="">
</div>
@foreach($droid as $dd)
@if($dd->filecat == 'sd')
Uploaded Secretary Details:&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
