              ...
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    <a class="btn btn-info" href="{{route('register_home_a_dzo',$token_no)}}" data-filter="1"><h3>???????????????????</h3></a>
                    <a class="btn btn-info active" href="{{route('chairman_details_dzo',$ro_id)}}" data-filter="2"><h3>???????????????????</h3></a>
                    <a class="btn btn-info" href="{{route('dychairman_details_dzo',$ro_id)}}" data-filter="3"><h3>???????????????????????? </h3></a>
                    <a class="btn btn-info" href="{{route('secretary_details_dzo',$ro_id)}}" data-filter="4"><h3>??????????????????? </h3></a>
                    <a class="btn btn-info" href="{{route('dysecretary_details_dzo',$ro_id)}}" data-filter="5"><h3>???????????????????????? </h3></a>
                    <a class="btn btn-info" href="{{route('treasurer_details_dzo',$ro_id)}}" data-filter="6"><h3>????????????????</h3></a>
                  </div>
                </div>
            <div class="row">
                <div class="col-md-4">
...
<input type="hidden" name="hidden_view2_dzo" id='hidden_view2_dzo' value="{{route('view2_addressss_dzo')}}">
              ...
              <button type="submit" class="btn btn-primary btn-sm"><h3> ???????</h3></button>
              <button type="submit" class="btn btn-danger btn-sm"><h3>??????</h3></button>
              </div>                   
            </form>
  ...
  {{ csrf_field() }}
            <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group input-group-sm">
                    <label for="dzongkhag"><h3>???????</h3></label>
                    <select name='type1' id='type1' class="form-control" required/>
                    <option disabled selected><h3>??????????????</h3></option>
                    <?php 
...
<i class="fa fa-fw fa-file-pdf"></i>?????????</a>
@endif                  
