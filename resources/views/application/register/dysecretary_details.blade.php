...
@if($token_no != '' && $dsroid == '')
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info active" href="{{route('dysecretary_details',$ro_id)}}" data-filter="5">Dy. Secretary Details</a>
            ...
            <div class="row">
                ...
                <form action="{{ route('cid_search_dsdreg',$ro_id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
  ...
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('dysecretary_details_store') }}">
...
<div class="form-group input-group-sm">
<label for="chairman">Upload Deputy Secretary Details Document:</label>
...
@foreach($data as $app)
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('dysecretary_details_store_edit') }}">
  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}"> 
...
@foreach($droid as $dd)
@if($dd->filecat == 'dsd')
Uploaded Deputy Secretary Details:&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
