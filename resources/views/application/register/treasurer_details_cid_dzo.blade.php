              ...
              <div class="card-body">
                <div>
                   <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info active" href="{{route('treasurer_details_dzo',$ro_id)}}" data-filter="6"><h3>རྩིས་འཛིན་ཁ་གསལ།</h3></a>
                  </div>
                </div>
            <div class="row">
                <div class="col-md-4">
                <div class="card-body">
                  ...
                  <form action="{{ route('cid_search_tdreg_dzo',$ro_id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
            <div class="input-group input-group-sm mb-0">
            <label class="col-sm-2 col-form-label" for="cid"><h3>ངོ་སྤྲད་ལག་ཁྱེར་ཨང་</h3></label>
...
?>
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('treasurer_details_store_dzo') }}">
...
@foreach($data as $app)
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('treasurer_details_store_edit_dzo') }}">
  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
...
<div class="form-group input-group-sm">
<label for="chairman"><h3>རྩིས་འཛིན་ཡིག་ཆ།</h3></label>
<input type="file" id="exampleInputFile2"  class="form-control" name="td[]" multiple="">
</div>
@foreach($droid as $dd)
@if($dd->filecat == 'td')
<h3>རྩིས་འཛིན་ཡིག་ཆ།</h3>&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
