...
<div class="container-fluid">
        <div class="row">         
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ route('search_token_dzo') }}">
          <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
          {{ csrf_field() }} 
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-12">
                      <h2 class="lead"><b><h3>བརྡ་མཚོན་ཨང་གྲངས།</h3></b></h2>
                ...
                <button type="submit" name="submit" class="btn btn-warning"><h3>འཚོལ་ཞིབ།</h3>&nbsp;&nbsp;<i class="fas fa-search"></i>
                </button>
                </div>
