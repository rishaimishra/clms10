...
@if($token_no != '' && $croid == '')
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info active" href="{{route('chairman_details',$ro_id)}}" data-filter="2">Chairman Details</a>
            ...
            <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('cid_search_cdreg',$ro_id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
...
?>
  ...
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('chairman_details_store') }}">
...
@foreach($data as $app)
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('chairman_details_store_edit') }}">
  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
...
@foreach($droid as $dd)
@if($dd->filecat == 'cd')
Uploaded Chairman Details:&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
