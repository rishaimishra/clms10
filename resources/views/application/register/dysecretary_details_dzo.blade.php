...
@if($token_no != '' && $dsroid == '')
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info active" href="{{route('dysecretary_details_dzo',$ro_id)}}" data-filter="5"><h3>དྲུང་ཆེན་འོགམ་གྱི་ཁ་གསལ། </h3></a>
            ...
            <div class="row">
                ...
                <div class="card-body">
                 ...
                 <form action="{{ route('cid_search_dsdreg_dzo',$ro_id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
  ...
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('dysecretary_details_store_dzo') }}">
...
<div class="form-group input-group-sm">
<label for="chairman"><h3>དྲུང་ཆེན་འོགམ་གྱི་ཡིག་ཆ།</h3></label>
...
@foreach($data as $app)
  <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('dysecretary_details_store_edit_dzo') }}">
  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}"> 
...
@foreach($droid as $dd)
@if($dd->filecat == 'dsd')
<h4>དྲུང་ཆེན་འོགམ་གྱི་ཡིག་ཆ།</h4>&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
