...
<div class="card-body">
<form class="search-form" role="form" enctype="multipart/form-data" method="POST" action="{{ route('update_tax_resubmit_dzo',$id) }}"> 
...
<i class="fa fa-fw fa-file-pdf"></i>སྔོན་ཞིབ</a>&nbsp;&nbsp;&nbsp;
    <a href="{{ route('delete_file_dzo', $dd->app_id) }}" onclick="return confirm('Are you sure, you want to Delete ?')">
    <span class="btn btn-outline-danger btn-xs"><h4><i class="fa fa-fw fa-trash"></i> ཕྱི་བཏོན</h4></span></a>
<br>
@elseif($dd->filecat == 'invoice')
<h3>ཚོང་ཟོག་ཐོ་ཡིག:</h3>&nbsp;&nbsp;&nbsp;{{ $dd->file_name }}
<a href="{{asset('/storage/'.$dd->doc_path)}}" target="youriframe">
<i class="fa fa-fw fa-file-pdf"></i>སྔོན་ཞིབ</a>&nbsp;&nbsp;&nbsp;
    <a href="{{ route('delete_file2_dzo', $dd->app_id) }}" onclick="return confirm('Are you sure, you want to Delete ?')">
    <span class="btn btn-outline-danger btn-xs"><h4><i class="fa fa-fw fa-trash"></i> ཕྱི་བཏོན</h4></span></a>
<br>
@endif
@endforeach
<br>
   <div class="form-row">
     <label for="chairman" class="col-sm-3 col-form-label"><h3>ཞུ་ཡིག:</h3></label>
     <input type="file" id="exampleInputFile2" class="form-control col-sm-6" name="application[]" multiple="" >
   </div> 
   <div class="form-row">
     <label for="chairman" class="col-sm-3 col-form-label"><h3>ཚོང་ཟོག་ཐོ་ཡིག:</h3></label>
