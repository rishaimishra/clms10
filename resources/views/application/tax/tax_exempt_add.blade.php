...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Apply for Tax Exemption.</h5>
              <p>
              <?php
...
<div class="card-body">
<form class="search-form" role="form" enctype="multipart/form-data" method="POST" action="{{ route('store_taxexempt') }}">  
{{ csrf_field() }}  
   <div class="form-row">
     <label for="chairman" class="col-sm-3 col-form-label">Upload Application:<font color="red">*</font></label>
     <input type="file" id="exampleInputFile2" class="form-control col-sm-6" name="application[]" multiple="" required="required"/>
   </div> 
   <div class="form-row">
     <label for="chairman" class="col-sm-3 col-form-label">Upload Invoice:<font color="red">*</font></label>
