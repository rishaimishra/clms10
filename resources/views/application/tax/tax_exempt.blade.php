            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('tax_exempt_re_add',$dc->id) }}" title="View Details">
                    <span class="btn btn-info btn-sm"><i class="fa fa-fw fa-hand-pointer"></i>&nbsp;&nbsp;&nbsp;Resubmit</span></a>
                    @endif
                    @if($dc->resubmit == '1')<span class="label label-warning">Resubmitted</span>
                    @endif
                  </td>           
              </tr> 
              @endforeach
