...
@if(Auth::user()->role_id == '3')
   ...
   <a href="{{ route('tax_exempt_add_dzo') }}" title="View Details">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('tax_exempt_re_add_dzo',$dc->id) }}" title="View Details">
                    <span class="btn btn-info btn-sm"><h4>ལོག་ཕུལ།</h4></span></a>
                    @endif
