...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3>སྙན་ཞུ་བཟོ་སྐྲུན།</h3></h5>
              <p>
              <?php
...
<div class="card-body">
     ...
     <a href="{{ route('report_zheldrang_dzo') }}" ><h3>.&nbsp;&nbsp;ཞལ་གྲངས། </h3></a>
     <a href="{{ route('report_donation_dzo') }}"><h3>.&nbsp;&nbsp;ཞལ་འདེབས།</h3></a>
     <a href="{{ route('report_visa_dzo') }}"><h3>.&nbsp;&nbsp;སྐྱོད་ཐམ་ཞུ་ཚིག།</h3></a>
     <a href="{{ route('report_financial_dzo') }}"><h3>.&nbsp;&nbsp;ལོ་བསྟར་དངུལ་གྱི་སྙན་ཞུ།</h3></a>
     <a href="{{ route('report_event_dzo') }}"><h3>.&nbsp;&nbsp;མཛད་རིམ།</h3></a>
     <a href="{{ route('report_member_dzo') }}"><h3>.&nbsp;&nbsp;འཐུས་མི་ཐོ་བཀོད།</h3></a>
     <a href="{{ route('report_deregistration_dzo') }}" ><h3>.&nbsp;&nbsp;ཐོ་བཀོད་ལས་ཕྱིར་འཐོན།</h3></a>
     <a href="{{ route('report_mom_dzo') }}" ><h3>.&nbsp;&nbsp;ཞལ་འཛོམས།</h3></a>
     <a href="{{ route('report_tax_dzo') }}" ><h3>.&nbsp;&nbsp;ཁྲལ་ཡངས་ཆག།</h3></a>
     <a href="{{ route('report_chapter_dzo') }}"><h3>.&nbsp;&nbsp;ཡན་ལག་ཆོས་སྡེ།</h3></a>
