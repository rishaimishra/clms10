...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Report on Registered Members.</h5>
              <p>
              <?php
...
<div class="card">
<div class="card-body">
<h3>Report For Individual RO's.</h3>

<form action="{{ route('memberreport_search') }}" method="POST">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-3">
...
<h3>General Report For All RO's.</h3>
<form action="{{ route('memberreport_searchall') }}" method="POST">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-3">
    <div class="form-group">
