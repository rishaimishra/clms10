...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Report on Donations.</h5>
              <p>
              <?php
...
<form action="{{ route('donationreport_search') }}" method="POST">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-3">
...
<form action="{{ route('donationreport_searchall') }}" method="POST">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-3">
    <div class="form-group">
