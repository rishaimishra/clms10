...
<table id="customers">
  ...
  @foreach($typesearch as $searchs)
    ...
    <td><?php if($searchs->branchtype == '1')
                  ...
                  {echo 'Others';}?></td>
    <td><?php echo $c = App\dzongkhag_dzo::where('dzongkhag_id', $searchs->dzongkhag)->value('dzongkhag_name'); ?></td>
    <td><?php echo $c = App\gewog_dzo::where('gewog_id', $searchs->gewog)->value('gewog_name'); ?></td>
    <td><?php echo $c = App\village_dzo::where('village_id', $searchs->village)->value('village_name'); ?></td>
