...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3> ཡན་ལག་ཆོས་སྡེ་སྙན་ཞུ་བཟོ་སྐྲུན། </h3></h5>
              <p>
              <?php
...
<div class="card">
<div class="card-body">
<form action="{{ route('chapterreport_search_dzo') }}" method="POST">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
    <div class="form-group">
      <p class="col-sm-2 col-form-label"><h3>དབྱེ་ཁག།<font color="red">*</font></h3></p>
