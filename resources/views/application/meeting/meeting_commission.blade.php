...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">New Commission Meeting Details</h5>
              <p>
              <?php
...
{{ csrf_field() }} 
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="meeting_no">Meeting Number:</label>   
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="description">Remarks:</label>
