...
@include('flash-message')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Religious Organization Registration Suspension</h5>
              <p>
              <?php
        ...
        <a href="{{ route('suspension_view') }}" title="View Details">
        <span class="btn btn-warning btn-bg"><i class="fa fa-fw fa-eye"></i>&nbsp;&nbsp;&nbsp;Click to View All Suspendend RO's</span></a>
      </div><!-- /.container-fluid -->
    </div>
...
<div class="card-body">
<form class="form-horizontal col-12" role="form" method="POST" enctype="multipart/form-data" action="{{ route('suspension_store') }}">  
{{ csrf_field() }} 
   <div class="form-row">
   ...
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="action">Action To be Taken:</label>
     <textarea class="form-control col-sm-6" name="action" id="action"rows="4"></textarea>
   </div>
   <br>
   <div class="form-row">
     <label class="col-sm-3 col-form-label"  for="event_details">Attach Order:</label>
