...
@include('flash-message') 
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark"><h3>བཀག་བཞག་འབད་ཡོད་མི་ ཚུ་གི་ཐོ། </h3></h5>
              <p>
              <?php
...
<br>
    ...
    <div class="container-fluid">
      ...
      <h5 class="box-title"><b><h3>བཀག་བཞག་འབད་ཡོད་མི་ ཚུ་གི་ཐོ། </h3></b></h5>
      </div>
  ...
  <div class="container-fluid">
            ...
            <thead>
              <tr style="text-align: left;">  
                  ...
                  <th><h3>རྒྱུ་མཚན།</h3></th>
                  <th><h3>ཞུ་བ་འབད་མི་སྤྱི་ཚེས།</h3></th>
                  <th><h3>དང་ལེན།</h3></th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $dc->updated_at }}</td>
                  <td>
                    <a href="{{ route('reinstate_dzo',$dc->id) }}" title="Reinstate Organization">
                    <span class="btn btn-success btn-sm"><i class="fa fa-fw fa-paste"></i><h3>གོ་གནས་ལུ་ལོག་བཀལ།</h3></span></a>
                  </td>           
              </tr> 
              @endforeach
            </tbody>
